                            ...
                            <div className="footer-widget">
                                ...
                                <div className="footer-social-icon">
                                    ...
                                    <div className="flex gap-4">
                                        <a href="https://www.facebook.com/sargolsavamazhar" target="_blank" rel="noopener noreferrer" className="p-3 bg-blue-50 rounded-full hover:bg-[#3B5998] hover:text-white transition-all hover:scale-110 hover:shadow-md text-[#3B5998]"><Facebook size={20} /></a>
                                        <a href="https://www.youtube.com/@artssportsazhar4556" target="_blank" rel="noopener noreferrer" className="p-3 bg-red-50 rounded-full hover:bg-[#FF0000] hover:text-white transition-all hover:scale-110 hover:shadow-md text-[#FF0000]"><Youtube size={20} /></a>
                                        <a href="https://www.instagram.com/azharsargolsavam?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className="p-3 bg-pink-50 rounded-full hover:bg-[#E1306C] hover:text-white transition-all hover:scale-110 hover:shadow-md text-[#E1306C]"><Instagram size={20} /></a>
                                        <a href="https://whatsapp.com/channel/0029VawdjdQ9mrGcSAsOYC2E" target="_blank" rel="noopener noreferrer" className="p-3 bg-green-50 rounded-full hover:bg-[#25D366] hover:text-white transition-all hover:scale-110 hover:shadow-md text-[#25D366]">
